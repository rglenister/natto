...
impl Piece {
    ...
    pub fn from_char(piece: char) -> Result<Piece, String> {
        let piece_color =
            if piece.is_ascii_uppercase() { PieceColor::White } else { PieceColor::Black };
...
mod tests {
    ...
    fn test_from_char() {
        assert_eq!(
            Piece::from_char('K'),
            Result::Ok(Piece { piece_color: White, piece_type: King })
        );
        assert_eq!(
            Piece::from_char('Q'),
            Result::Ok(Piece { piece_color: White, piece_type: Queen })
        );
        assert_eq!(
            Piece::from_char('R'),
            Result::Ok(Piece { piece_color: White, piece_type: Rook })
        );
        assert_eq!(
            Piece::from_char('B'),
            Result::Ok(Piece { piece_color: White, piece_type: Bishop })
        );
        assert_eq!(
            Piece::from_char('N'),
            Result::Ok(Piece { piece_color: White, piece_type: Knight })
        );
        assert_eq!(
            Piece::from_char('P'),
            Result::Ok(Piece { piece_color: White, piece_type: Pawn })
        );

        assert_eq!(
            Piece::from_char('k'),
            Result::Ok(Piece { piece_color: Black, piece_type: King })
        );
        assert_eq!(
            Piece::from_char('q'),
            Result::Ok(Piece { piece_color: Black, piece_type: Queen })
        );
        assert_eq!(
            Piece::from_char('r'),
            Result::Ok(Piece { piece_color: Black, piece_type: Rook })
        );
        assert_eq!(
            Piece::from_char('b'),
            Result::Ok(Piece { piece_color: Black, piece_type: Bishop })
        );
        assert_eq!(
            Piece::from_char('n'),
            Result::Ok(Piece { piece_color: Black, piece_type: Knight })
        );
        assert_eq!(
            Piece::from_char('p'),
            Result::Ok(Piece { piece_color: Black, piece_type: Pawn })
        );
