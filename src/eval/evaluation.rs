...
pub fn score_position(position: &Position) -> isize {
    ...
    let blended_score = (mg * phase + eg * (PHASE_TOTAL - phase)) / PHASE_TOTAL;
...
mod tests {
    ...
    fn test_king_scores() {
        ...
        assert_eq!(score_position(&position), 52);
    }
