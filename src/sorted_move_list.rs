...
impl SortedMoveList {
    pub fn new(moves: &Vec<ChessMove>) -> SortedMoveList {
    ...
    pub fn add_moves(&mut self, moves: &Vec<ChessMove>) {
        moves.iter().for_each(|move_to_add| {
            self.moves_to_score_map.insert(move_to_add.clone(), 0);
        })
    }
    
    pub fn update_score(&mut self, chess_move: &ChessMove, score: isize) {
        self.moves_to_score_map.insert(chess_move.clone(), score);
    }
    ...
    pub fn get_all_moves(&self) -> Vec<ChessMove> {
        self.entries().into_iter().map(|entry| entry.0.clone()).collect()
    }
}
...
mod tests {
    ...
    fn test_add_one_move() {
        let chess_move = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 2, false)} };
    ...
    fn test_add_two_moves() {
        let chess_move_1 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 2, false)} };
        let chess_move_2 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 3, false)} };
    ...
    fn test_equal_moves() {
        let chess_move_1 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 2, false)} };
        let chess_move_2 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 3, false)} };
        let chess_move_3 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 2, false)} };
        let chess_move_4 = ChessMove::BasicMove { base_move: { BaseMove::new( 1, 2, true)} };
